...
function BrandCars() {
  ...
  const faqs = [
    ...
    {
      question: `Can I rent a ${brandName} in Muscat without a driver?`,
    ...
    {
      question: `What ${brandName} models are available for rent?`,
      answer: `We offer a premium selection of ${brandName} vehicles. Our fleet is regularly updated to provide you with the latest models. Contact us for current availability.`
    }
  ]
  ...
  // All available cars data with brand information
  const allCarsData = [
    // Ferrari Cars
    {
      id: 1,
  ...
  const brandCars = allCarsData.filter(car => car.brand === brandName)
          ...
          <div className="container max-w-[1200px] mx-auto px-5">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
              ...
              <div className="flex items-center gap-2 bg-black/80 rounded-full px-4 py-2">
                ...
                <span className="text-white">/</span>
                <span className="text-[#b71c1c] font-medium">{brandName}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-[1200px] mx-auto px-5">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
            <h1 className="text-[20px] md:text-[20px] lg:text-[25px] font-bold text-black leading-tight">
              Rent Premium {brandName} Cars in Oman
            </h1>
          ...
          <div className="max-w-[1200px] mx-auto text-center">
            <p className="text-[14px] md:text-[15px] text-gray-700 leading-relaxed mb-4">
              Discover the ultimate driving experience with {brandName} car rentals in Oman. At Ojis Car Rental Oman, we offer a premium selection of {brandName} vehicles with comprehensive insurance, 24/7 support, and free delivery across Oman.
            </p>
          ...
          {brandCars.length > 0 ? (
            ...
            <div className="text-center py-12">
              <p className="text-[18px] text-gray-700">
                No {brandName} cars available at the moment. Please check back later or contact us for more information.
              </p>
            </div>
          )}
        </div>
        ...
        <div className="max-w-[900px] mx-auto px-5">
          <div className="relative bg-white border border-gray-200 shadow-lg p-8 md:p-12 transition-all duration-300 hover:shadow-xl">
            ...
            <h2 className="text-[20px] md:text-[25px] font-bold text-black mb-4">
              Rent Premium {brandName} Cars at Competitive Prices in Oman
            </h2>
            
            <p className="text-[14px] md:text-[16px] text-gray-700 leading-relaxed mb-4">
              Looking for a {brandName} that matches your budget? Understanding Oman's car rental rates allows you to find the perfect vehicle without overspending. At Ojis Car Rental Oman, we make premium {brandName} rentals affordable with flexible plans and transparent pricing—all designed to suit every budget and lifestyle.
            </p>

            <p className="text-[14px] md:text-[16px] text-gray-700 leading-relaxed">
              Whether you're cruising through Oman's vibrant streets or venturing across its golden dunes, our {brandName} vehicles offer the perfect mix of elegance and value—turning every drive into a first-class experience.
            </p>
        ...
        <div className="max-w-[1200px] mx-auto px-5">
          ...
          <div className="text-center mb-1">
            <h2 className="text-[#b71c1c] text-[26px] md:text-[36px] font-bold">
              Believe {brandName} Rentals Are Too Expensive? Think Again.
            </h2>
          </div>
          ...
          <div className="space-y-6 text-white text-[14px] md:text-[16px] leading-relaxed max-w-[1300px] mx-auto text-center">
            <p>
              Who says renting a {brandName} has to be expensive or difficult? At Ojis Car Rental Oman, we're transforming the way you experience premium driving. Our carefully curated fleet includes {brandName} vehicles designed to deliver exceptional performance, striking design, and unmatched comfort — all available at affordable rates designed to suit your budget without compromising on quality or style.
            </p>
            ...
            <p>
              Whether it's a night out, a business journey, or simply the thrill of driving your dream {brandName}, Ojis Car Rental Oman makes luxury rentals simple, affordable, and unforgettable. Plus, with our 24/7 support team just a call away, you can enjoy complete peace of mind on the road. Every ride with Ojis Car Rental Oman VIP feels like first-class luxury — without the hefty price tag.
            </p>
          </div>
        </div>
      </div>

      {/* Looking for luxury vehicles section */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center bg-white border border-gray-200 rounded-lg p-4 shadow-lg">
            ...
            <div className="space-y-6 px-4">
              <h2 className="text-[20px] md:text-[28px] font-bold text-black mb-4">
                Why a {brandName} Rental in Oman Makes All the Difference
              </h2>
              <p className="text-[14px] md:text-[15px] text-gray-700 leading-relaxed">
                Discover Oman in a {brandName} and transform every drive into a truly memorable experience. Whether you're cruising along scenic coastal highways, taking in Muscat's stunning skyline, or arriving at a high-profile event, a premium {brandName} makes every moment extraordinary. Ojis Car Rental Oman offers a carefully curated fleet featuring top-tier {brandName} models, delivering unmatched comfort, cutting-edge performance, and striking design. With no-deposit rentals and flexible plans, you can enjoy luxury driving without financial concerns.
              </p>

              <h2 className="text-[20px] md:text-[28px] font-bold text-black mb-4 pt-4">
                Elevate Your Journey to First-Class with {brandName}
              </h2>
              <p className="text-[14px] md:text-[15px] text-gray-700 leading-relaxed">
                Why settle for ordinary when you can experience extraordinary? At Ojis Car Rental Oman, we do more than just provide cars — we craft memorable driving experiences. Choose from our exclusive fleet of {brandName} vehicles, each built to impress and enhance your journey. Whether you're attending a high-profile event or taking a scenic drive along Oman's coastline, we ensure every ride radiates style, elegance, and confidence. With no-deposit rentals, fast delivery, and a customer-focused approach, you can enjoy Oman in luxury and comfort without any hassle.
              </p>
            </div>
